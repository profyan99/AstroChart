// ## Settings #############################
const settings = function (astrology) {
  ...
  astrology.SYMBOL_SIGNS = [
    {
      id: astrology.SYMBOL_ARIES,
      name: 'Овен',
      description: 'Огонь Кардинальный',
    },
    {
      id: astrology.SYMBOL_TAURUS,
      name: 'Телец',
      description: 'Земля Фиксированный',
    },
    {
      id: astrology.SYMBOL_GEMINI,
      name: 'Близнецы',
      description: 'Воздух Мутабельный',
    },
    {
      id: astrology.SYMBOL_CANCER,
      name: 'Рак',
      description: 'Вода Кардинальный',
    },
    {
      id: astrology.SYMBOL_LEO,
      name: 'Лев',
      description: 'Огонь Фиксированный',
    },
    {
      id: astrology.SYMBOL_VIRGO,
      name: 'Дева',
      description: 'Земля Мутабельный',
    },
    {
      id: astrology.SYMBOL_LIBRA,
      name: 'Весы',
      description: 'Воздух Кардинальный',
    },
    {
      id: astrology.SYMBOL_SCORPIO,
      name: 'Скорпион',
      description: 'Вода Фиксированный',
    },
    {
      id: astrology.SYMBOL_SAGITTARIUS,
      name: 'Стрелец',
      description: 'Огонь Мутабельный',
    },
    {
      id: astrology.SYMBOL_CAPRICORN,
      name: 'Козерог',
      description: 'Земля Кардинальный',
    },
    {
      id: astrology.SYMBOL_AQUARIUS,
      name: 'Водолей',
      description: 'Воздух Фиксированный',
    },
    {
      id: astrology.SYMBOL_PISCES,
      name: 'Рыбы',
      description: 'Вода Мутабельный',
    },
  ];
